...
<p class="mb-4">@include('partials.ui.link', ['label' => 'Crear nueva tarea', 'url' => route('tasks.create') ])</p>
<p>@include('partials.ui.link', ['label' => 'Crear nueva categoría', 'url' => route('categories.create') ])</p>
